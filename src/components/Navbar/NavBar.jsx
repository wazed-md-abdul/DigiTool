    ...
    <>
      <div className="navbar w-full md:w-8/12 mx-auto  ">
        ...
        <div className="navbar-end gap-2 md:gap-5">
          ...
          <button className='btn bg-white text-sm md:text-lg p-3 md:p-6 border-none font-extralight rounded-full'><div className='mr-2 relative'>{length>0 && <a className=' btn rounded-full h-4 w-4 md:h-5 md:w-5 p-2 md:p-3 text-xs md:text-md text-white bg-red-600 -top-2 md:-top-3.5 absolute'>{length}</a>}< ShoppingCart size={16} className="md:w-5 md:h-5" /></div>Login</button>
